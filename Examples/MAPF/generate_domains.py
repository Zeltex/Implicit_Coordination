...
def print_all():
	...
	goals = [
		...
		[['c0', 'x1'],['c1', 'x2'],['c2', 'x3'],['c3','x4'],['c4','c5']],
		[['c0', 'x1'],['c1', 'x3'],['c3', 'x4'],['c4','x6'],['c6','c7']],
		[['c0', 'x1'],['c1', 'x3'],['c3', 'x6'],['c6','x8'],['c8','c9']],
		]
	starts = [
		['c2', 'c1'],
		['c4', 'c2'],
	...
	n_cells = [3, 5, 7, 9, 11, 13, 4, 6, 8, 10, 12, 5, 7, 9, 11, 6, 8, 10]
...
"""
		...
		for agent in range(n_agents):
			output += F"{t}{t}a{agent} = {co}{nl}{t}{t}{t}("
			set0 = []
			set1 = []
			
			for k in range(n_worlds):
				if (k % 2 ** (agent + 1) < 2 ** agent):
					set0.append(k)
				else:
					set1.append(k)
