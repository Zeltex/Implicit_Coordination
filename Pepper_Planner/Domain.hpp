...
namespace del {
	...
	public:
		...
		const std::vector<Proposition_Instance>		get_atom_rigids() const;
		...
		void set_rigid_atoms(std::vector<Proposition_Instance> rigid_atoms);
	...
	private:
		...
		std::vector<Proposition_Instance> rigid_atoms;
