...
namespace del {
    ...
    Formula_Id Formula::f_and(std::vector<Formula_Id> formulas)
    {
        formulas.emplace_back(Formula_Types::And, formulas);
        return Formula_Id{ formulas.size() - 1 };
    }

    Formula_Id Formula::f_or(std::vector<Formula_Id> formulas)
    {
        formulas.emplace_back(Formula_Types::Or, formulas);
        return Formula_Id{ formulas.size() - 1 };
    }
